...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/11 10:31:21 by apolo-to          #+#    #+#             */
/*   Updated: 2023/08/17 16:25:53 by apolo-to         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
char	*ft_strjoin_gnl(char *static_line, char *buffer)
{
	char	*final_line;
	size_t	i;
	size_t	j;
	...
	if (!buffer)
		return (NULL);
	final_line = malloc(sizeof(char) * (ft_strlen_gnl(static_line)
